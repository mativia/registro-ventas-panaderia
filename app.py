...
btn_add = tk.Button(frame_ventas, text="Agregar", command=agregar_venta, width=10, height=2)
btn_add.grid(row=0, column=1, padx=10, pady=(10, 5))

btn_delete = tk.Button(frame_ventas, text="Eliminar", command=eliminar_venta, width=10, height=2)
